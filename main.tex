...
\begin{lstlisting}
https://github.com/Chandragirisaiteja/Assignment5.git
\end{lstlisting}
%
...
Question taken from
\begin{lstlisting}
https://github.com/gadepall/ncert/blob/main/linalg/quadratic_forms/gvv_ncert_quadratic_forms.pdf
\end{lstlisting}
\section{quad}
...
\item 
$2x^2 - 6x + 3 = 0$ can be expressed as 
\begin{align}
\label{eq:5.2.7_vec_conic_a}
\vec{x}^T \myvec{2 & 0\\0 & 0}\vec{x}+ \myvec{-6 & 0}\vec{x}+3=0
\end{align}
...
\end{align}
From the graph in \ref{fig:5.2.7_par1}, the roots are 3 and $\frac{3}{2}$. 
\begin{figure}[!ht]
\centering
\includegraphics[width= \columnwidth]{quad.png}
\caption{Roots of $2x^2 - 6x + 3 = 0$}
